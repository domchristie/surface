...
,
		"rect" : [ 435.0, 44.0, 661.0, 826.0 ],
		"bglocked" : 0,
		"defrect" : [ 435.0, 44.0, 661.0, 826.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "7",
					"patching_rect" : [ 45.0, 660.0, 29.0, 18.0 ],
					"id" : "obj-13",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "0",
					"patching_rect" : [ 30.0, 600.0, 32.5, 18.0 ],
					"id" : "obj-11",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "sel 8",
					"patching_rect" : [ 75.0, 630.0, 36.0, 20.0 ],
					"id" : "obj-9",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 75.0, 600.0, 92.0, 20.0 ],
					"id" : "obj-10",
					"fontname" : "Arial",
					"numinlets" : 6,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "set channel",
					"patching_rect" : [ 360.0, 510.0, 150.0, 20.0 ],
					"id" : "obj-3",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "+ #1",
					"patching_rect" : [ 360.0, 600.0, 34.0, 20.0 ],
					"id" : "obj-4",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "LEDs",
					"patching_rect" : [ 30.0, 540.0, 43.0, 20.0 ],
					"id" : "obj-2",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 735.0, 189.0, 20.0 ],
					"id" : "obj-5",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 225.0, 630.0, 154.0, 20.0 ],
					"id" : "obj-67",
					"fontname" : "Arial",
					"numinlets" : 3,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "91",
					"patching_rect" : [ 225.0, 420.0, 50.0, 18.0 ],
					"id" : "obj-64",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "91",
					"patching_rect" : [ 330.0, 300.0, 50.0, 18.0 ],
					"id" : "obj-62",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "slider",
					"patching_rect" : [ 225.0, 465.0, 30.0, 140.0 ],
					"presentation" : 1,
					"id" : "obj-39",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 705.0, 143.0, 20.0 ],
					"id" : "obj-32",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 12.0,
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 234.5, 446.0, 388.5, 446.0, 388.5, 290.0, 370.5, 290.0 ]
				}
